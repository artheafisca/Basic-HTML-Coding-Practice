...
function kalkulasiNilaiTotal(uts, uas, tugas) {
    ...
    // - 30% dari nilai Tugas
    // - 40% dari nilai UAS
    const nilaiTotal = (0.3 * nilaiUts) + (0.4 * nilaiUas) + (0.3 * nilaiTugas);
  ...
  function cetakHasil(total) {
    ...
    if(apakahLulus) {
      ...
      kalimatHasil = "Selamat ! Anda lulus dengan nilai" + " " + nilaiTotal;
      ...
      kalimatHasil = "Mohon maaf ... Anda dinyatakan tidak lulus karena nilai Anda kurang dari 70."
      console.log(kalimatHasil);
    }
  }
